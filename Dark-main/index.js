...
break
				...
				case 'mia2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/gallery/c9gMEi6`)
				...
				case 'nsfwloli':
					...
					case 'solador':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/bwCeCkg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'o brabo'})
					break
				case 'hilih':
